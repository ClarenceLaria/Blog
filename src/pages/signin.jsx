         ...
         <div className='w-screen h-screen flex flex-col items-center justify-center  ' >
            <div className="form h-full w-full flex">
                ...
                <div className="details-login h-full w-full flex flex-col gap-5   ">
                    <form action="" method="get" className=' border h-full  px-20 flex flex-col justify-center items-center'>
                    ...
                    <input className='w-full px-3 bg-transparent border-b-2 border-b-zinc-500  rounded-sm  outline-none py-1 required:  ' type="text/ email" placeholder='User Name/ Email' required/>
                   ...
                   <p className='flex justify-end gap-1 px-2 -mt-5'>Don't have an account. <span> <Link to="/signup" className=' no-underline transition-all ease-in-out text-orange-500 hover:text-black  ' > Sign up</Link> </span></p>
                </div>
                    </form>
                </div>
