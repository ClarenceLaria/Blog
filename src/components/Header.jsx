...
const Header = () => {
  return (
    <header className="header  p-16 text-black text-sm  top-0 bg-white font-[Poppins]">
      <div className="top flex justify-between">
        ...
        <nav className="navbar hidden md:block lg:block ">
          <ul className="nav-list  gap-10 flex justify-between">
            ...
            <li className="nav-item cursor-pointer hover:text-orange-400 transition-all ease-in-out" ><Link to="/read">Blog</Link></li>
